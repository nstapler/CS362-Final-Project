...
import UnitTestAndCode.calculator as calc
...
class TestFactorial(unittest.TestCase):
    def testFactorial(self):
        ...
        self.assertEqual(False, calc.factorial(self.posFloat))
        self.assertEqual(False, calc.factorial(self.fraction))
        # negative cases
        self.assertEqual(0, calc.factorial(self.negInt))
        self.assertEqual(0, calc.factorial(self.negFraction))
        # other
        self.assertEqual(0, calc.factorial(self.zeroCase))
        self.assertEqual(False, calc.factorial(self.invalidChar))
        if self.hugeNumber > 2147483647:
            self.assertEqual(False, calc.factorial(self.hugeNumber))
        else:
            self.assertEqual(math.factorial(self.hugeNumber), calc.factorial(self.hugeNumber))
...
class TestSquare(unittest.TestCase):
    def test_square(self):
        helper.prepTestInputs(self)
        # positive case
        self.assertEqual(self.posInt*self.posInt, calc.square(self.posInt))
        self.assertEqual(self.posFloat*self.posFloat, calc.square(self.posFloat))
        self.assertEqual(self.fraction*self.fraction, calc.square(self.fraction))
        # negative cases
        self.assertEqual(self.negInt*self.negInt, calc.square(self.negInt))
        self.assertEqual(self.negFraction*self.negFraction, calc.square(self.negFraction))
        # other
        self.assertEqual(0,calc.square(self.zeroCase))
        self.assertEqual(False, calc.square(self.invalidChar))
        self.assertEqual(self.hugeNumber*self.hugeNumber,
...
class TestFraction(unittest.TestCase):
    def test_fraction(self):
        ...
        # other
        self.assertEqual(False, calc.fraction(self.zeroCase))
